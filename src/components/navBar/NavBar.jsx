    ...
    <div className={styles.top}>
      <div className={styles.navbar}>
        ...
        >
          ...
          <Link className="hover:scale-125">Skills</Link>
          <Link className="hover:scale-125">Projects</Link>
          <Link className="hover:scale-125">About me</Link>
          <Link className="hover:scale-125">Contact</Link>
          <DarkMode />
        </div>
      </div>

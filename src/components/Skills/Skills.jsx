  ...
  return (
    <div className={styles.skill}>
      ...
      <div className={styles.boxes}>
        <div className="h-auto rounded-2xl px-8 py-16 pt-32 grid grid-cols-4 max-sm:grid-cols-3 gap-10 relative z-10 max-lg:w-full  max-lg:pt-32 bg-[#f6e7e7] dark-shadow border-2 shadow-[10px_25px_50px_-5px_rgba(0,0,0,0.5)]  min-[1921px]:grid-cols-4   min-[2250px]:grid-cols-5 max-lg:p-8 max-lg:gap-5">
          ...
          {skills.map((item) => (
            ...
            >
              {item.icon}
              <h3 className="text-black max-lg:text-[1.6rem] min-[1024px]:hidden">
                {item.name}
              </h3>

...
let skills = [
  {
    icon: <FaHtml5 size={80} color="red" />,
    name: "HTML",
  },
  {
    icon: <FaCss3Alt size={80} color="blue" />,
    name: "CSS",
  },
  {
    icon: <IoLogoJavascript size={80} color="orange" />,
    name: "Java Script",
  },
  {
    icon: <FaReact size={80} color="lightblue" />,
    name: "React",
  },
  {
    icon: <SiTailwindcss size={80} color="violet" />,
    name: "Tailwind",
  },
  {
    icon: <FaNodeJs size={80} color="brown" />,
    name: "NodeJs",
  },
  {
    icon: <SiExpress size={80} color="black" />,
    name: "Express",
  },
  {
    icon: <FaSass size={80} color="darkblue" />,
    name: "Sass/Scss",
  },
  {
    icon: <SiMongodb size={80} color="green" />,
    name: "MongoDb",
  },
];
  ...
  return (
    <div className={styles.skill}>
      ...
      <div className={styles.boxes}>
        <div
          className="h-auto rounded-2xl px-8 py-16 pt-32 grid grid-cols-3 gap-10 relative z-10 max-lg:w-full  max-lg:pt-32 bg-[#f6e7e7] dark-shadow border-2 shadow-[10px_25px_50px_-5px_rgba(0,0,0,0.5)]  min-[1921px]:grid-cols-4   min-[2250px]:grid-cols-5
      max-lg:p-8  max-lg:gap-5 "
        >

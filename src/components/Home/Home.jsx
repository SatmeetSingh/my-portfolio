        ...
        <div className={styles.intro}>
          ...
          <div className={styles.text}>
            <p>
              ...
              focused on creating clean, user-friendly websites and
              applications. I turn caffeine into code, one line at a time,
              blending creativity with technical expertise and a touch of
              down-to-earth charm.
            </p>
          </div>
